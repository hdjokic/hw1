...
const Product = class Product {
    constructor(input){
        ...
        this.name = myArr[0];
        this.price = Number(myArr[1]);
        this.pricewithCents = myArr[1];
        this.availability = myArr[2];
    }
    /**
     * *****************
     * ***** TODO ******
    ...
    static halfOff = (products) => {
        ...
        //return products.forEach(x=> x.price=x.price*0.5);
    ...
    static printProducts = (products) => {
        products.map(
            x => console.log("Product: "+ x.name + ", Cost: $" + x.pricewithCents + ", Availability: " + (x.availability==="In Stock"? "Yes" : "No"))
            );
    }
 };
